...
describe Geoblacklight::Reference do
  let(:typical_reference) do
    described_class.new(["http://www.opengis.net/def/serviceType/ogc/wms"])
  end
  ...
  describe "#initialize" do
    it "instance variable reference is set" do
      expect(typical_reference.instance_variable_get(:@reference)).to eq ["http://www.opengis.net/def/serviceType/ogc/wms"]
    end
  end
