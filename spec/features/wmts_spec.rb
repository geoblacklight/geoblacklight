...
feature "wmts layer" do
  context "when referencing a WMTSCapabilities document with a single layer" do
    scenario "displays the layer", js: true do
      ...
      proxy.stub("https://map-tiles-staging.princeton.edu/2a91d82c541c426cb787cc62afe8f248/mosaicjson/WMTSCapabilities.xml")
        .and_return(status: 200, body: read_fixture("manifests/wmts-single.xml"))
  ...
  context "when referencing a WMTSCapabilities document with a multiple layers" do
    scenario "displays the layer referenced in the layer_id field", js: true do
      # Mock wmts manifest url
      proxy.stub("https://maps.wien.gv.at/wmts/1.0.0/WMTSCapabilities.xml")
        .and_return(status: 200, body: read_fixture("manifests/wmts-multiple.xml"))
