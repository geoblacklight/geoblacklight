# Monkeypatch Blacklight::Icon to work with Sprockets
...
module Blacklight
  class Icon
    ...
    def file
      if defined?(Propshaft) && defined?(Propshaft::Environment) && Rails.application.assets.is_a?(Propshaft::Environment)
