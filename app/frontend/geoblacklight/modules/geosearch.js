...
((global) => {
  ...
  class GeoSearch extends L.Control {
    ...
    onAdd(map) {
      ...
      const staticButtonExists = () => {
        if (typeof(this.staticButton) != 'undefined' && this.staticButton != null) {
          return true;
        }
        else {
          return null;
      ...
      const dynamicSearcher = GeoBlacklight.debounce(() => {
        if (this.options.dynamic) {
          this.options.searcher.apply(this);
        }
      }, this.options.delay);
      ...
      if (this.options.dynamic) {
        ...
        if (typeof(this.dynamicButton) != 'undefined' && this.dynamicButton != null) {
          this.dynamicButton.style.display = 'block';
          this.staticButton.style.display = 'none';
        }
      }
  ...
  L.control.geosearch = (options) => new GeoSearch(options);
